...
#include "../api/qextserialport/src/portlistener.h"
...
struct qt_meta_stringdata_PortListener_t {
    QByteArrayData data[5];
    char stringdata[46];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PortListener_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PortListener_t qt_meta_stringdata_PortListener = {
    {
QT_MOC_LITERAL(0, 0, 12), // "PortListener"
QT_MOC_LITERAL(1, 13, 11), // "onReadyRead"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 12), // "onDsrChanged"
QT_MOC_LITERAL(4, 39, 6) // "status"

    },
    "PortListener\0onReadyRead\0\0onDsrChanged\0"
    "status"
};
...
const QMetaObject PortListener::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PortListener.data,
      qt_meta_data_PortListener,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PortListener::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PortListener.stringdata))

...
#include "../BCI/bci_c_brsh_io_debug.h"
...
void *C_BRSH_IO_Debug::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "C_Singleton<C_BRSH_IO_Debug>"))
        return static_cast< C_Singleton<C_BRSH_IO_Debug>*>(const_cast< C_BRSH_IO_Debug*>(this));
